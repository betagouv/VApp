import { NotationAideProjetServiceInterface } from '@/domain/services/notation-aide-projet-service.interface';
import { NOTE_MAX, NOTE_MIN } from '@/domain/note';
import { Aide } from '@/domain/models/aide';
import { Projet } from '@/domain/models/projet';

export class RandomNotationAideService implements NotationAideProjetServiceInterface {
