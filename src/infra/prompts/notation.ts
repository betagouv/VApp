...
\ ${Math.floor(NOTE_MAX * 0.2)} : L'aide ou la subvention correspond très bien aux objectifs et aux besoins du projet.
...
\ ${Math.floor(NOTE_MIN * 0.2)} : L'aide ou la subvention a une correspondance minimale avec les objectifs et les besoins du projet.
