...
export const criteres = `${AideScore.fromUnitInterval(1)} : L'aide correspond parfaitement aux objectifs et aux besoins du projet.
...
${AideScore.fromUnitInterval(0.8)} : L'aide correspond très bien aux objectifs et aux besoins du projet.
...
${AideScore.fromUnitInterval(0.7)} : L'aide correspond partiellement aux objectifs et aux besoins du projet.
...
${AideScore.fromUnitInterval(0.5)} : L'aide a une faible correspondance avec les objectifs et les besoins du projet.
...
${AideScore.fromUnitInterval(0.3)} : L'aide correspond très peu aux objectifs et aux besoins du projet.
...
${AideScore.fromUnitInterval(0)} : La description du projet est insuffisamment détaillée ou l'aide n'a aucune correspondance avec les objectifs et les besoins du projet.
