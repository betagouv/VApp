...
import { AidesEligibles } from '@/ui/components/AideEligibles';
import { GridItemLoader } from '@/ui/components/GridItemLoader';
import { ViewAideEligible } from '@/ui/dtos/view-aide-eligible';
import { useMountEffect } from '@/ui/hooks/useMountEffect';
import { rechercherAidesProjetAction } from '@/application/actions/rechercher-aides-projet.action';
import { AideEligible } from '@/domain/models/aide-eligible';
import { useRouter } from 'next/navigation';
import { DynamicAtAidTypeSelect } from '@/ui/components/DynamicAtAidTypeSelect';
