    ...
    <Grid haveGutters>
      <GridCol md={4}>
        <Card
          ...
          start={
            <strong className="fr-display--md">{matomoData.nbVisits}</strong>
          }
          size="large"
          grey
        />
      ...
      <GridCol md={4}>
        <Card
          ...
          start={
            <strong className="fr-display--md">{matomoData.nbPageViews}</strong>
          }
          size="large"
          grey
        />
      ...
      <GridCol md={4}>
        <Card
          ...
          start={
            <strong className="fr-display--md">
              {matomoData.nbUniqPageViews}
            </strong>
          }
          size="large"
          grey
