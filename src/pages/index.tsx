  ...
  return (
    <>
      ...
      <div className={fr.cx('fr-grid-row', 'fr-grid-row--center')}>
        <div className={fr.cx()}>
          <h1>Template</h1>
          Ce template minimal en Next.js met en oeuvre les pratiques recommandées chez betagouv et peut vous faire{' '}
          <b>gagner du temps</b>.
          <br />
          <br />
          ...
          <br />
          <br />
          Vous pouvez vous en servir comme base de départ ou comme référence d&apos;implémentation.{' '}
          <b>
            <a href="https://github.com/betagouv/template-nextjs" target="_blank" rel="noreferrer noopener">
          ...
          <Accordion label="🇫🇷 Système de design de l'état (DSFR)" titleAs="h2">
            ...
            <a href="https://github.com/codegouvfr/react-dsfr" target="_blank" rel="noreferrer noopener">
          ...
          <Accordion label="🚨 Alertes sentry" titleAs="h2">
            Intègre une sonde sentry pour être alerté en temps réel des erreurs applicatives et monitorer les
          ...
          <Accordion label="⚖️ Conformité juridique" titleAs="h2">
            ...
            <ul>
              <li>
                <Link href="/accessibilite">Déclaration d&apos;accessibilité numérique</Link>
              </li>
              <li>
          ...
          <Accordion label="✅ Standards beta" titleAs="h2">
            <ul>
              ...
              <li>
                ...
                <a target="_blank" rel="noreferrer noopener" href="https://github.com/GouvernementFR/dsfr-chart">
                  dsfr-chart
                </a>{' '}
          ...
          <Accordion label="🔎 Testing" titleAs="h2">
            <ul>
              <li>
                ...
                <a target="_blank" rel="noreferrer noopener" href="https://playwright.dev">
                  Playwright
                </a>
              </li>
              <li>
                Tests unitaires avec{' '}
                <a target="_blank" rel="noreferrer noopener" href="https://vitest.dev">
                  vitest
                </a>
              </li>
              <li>
                <a target="_blank" rel="noreferrer noopener" href="https://storybook.js.org/">
                  Storybook
                </a>{' '}
